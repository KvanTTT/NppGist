...
namespace NppGist.Forms
{
    public partial class dlgOpenGist : Form
    {
        ...
        public dlgOpenGist()
        {
            ...
            paginator = new Paginator(tvGists, btnPrevPage, btnNextPage, tbPageNumber, false);
        ...
        private async void frmGists_Load(object sender, EventArgs e) => await paginator.UpdateGists(PageStatus.Init);
        ...
        private void tvGists_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                if (tvGists.SelectedNode.Parent != null || paginator.Gists[tvGists.SelectedNode.Name.Split('/')[0]].Files.Count == 1)
        ...
        private async void tvGists_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Delete)
                await GuiUtils.DeleteItem(tvGists, paginator.Gists, false);
            else if (e.KeyCode == Keys.F2)
                await GuiUtils.RenameItem(tvGists, paginator.Gists, false);
        }
        ...
        private void btnGoToGitHub_Click(object sender, EventArgs e) => GuiUtils.GoToGitHub(tbGistLink.Text);
        ...
        private void cbCloseOpenDialog_CheckedChanged(object sender, EventArgs e)
        {
            ...
            Win32.WritePrivateProfileString("Settings", "CloseOpenDialog",
                Convert.ToInt32(Main.CloseOpenDialog).ToString(), Main.IniFileName);
        }
        ...
        private void btnCancel_Click(object sender, EventArgs e) => closeDialog = true;
